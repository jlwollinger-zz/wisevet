...
describe('Service Tests', () => {
    describe('Papel Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Papel(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Papel', async () => {
            ...
            it('should update a Papel', async () => {
                const returnedFromService = Object.assign(
                    {
                        descricao: 'BBBBBB',
                        nome: 'BBBBBB'
            ...
            it('should return a list of Papel', async () => {
                const returnedFromService = Object.assign(
                    {
                        descricao: 'BBBBBB',
                        nome: 'BBBBBB'
            ...
            it('should delete a Papel', async () => {
